  ...
  <div class="lower-mv__inner inner">
    <div class="lower-mv__txt">
      ...
      <h1 class="lower-mv__ttl">
        <span class="lower-mv__ttl-ja"><?php echo esc_html($term->name); ?>の<br class="only-sp">セミナー一覧</span>
      </h1>
    </div>
  </div>
</div>
...
<section class="l-articles section">
  <div class="l-articles__inner inner">
    <div class="l-articles__slider c-card__container">
		...
		get_template_part('components/c-card-seminar-category', null, $args = array(
		  'posts_per_page' => 12,
		  'list' => true,
		  'tag' => true,
		  'sp-slider' => false,
